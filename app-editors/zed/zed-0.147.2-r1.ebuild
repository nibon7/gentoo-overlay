...
declare -A GIT_CRATES=(
	...
	[tree-sitter-heex]="https://github.com/phoenixframework/tree-sitter-heex;6dd0303acf7138dd2b9b432a229e16539581c701"
	[tree-sitter-language]="https://github.com/tree-sitter/tree-sitter;${TS_COMMIT};tree-sitter-%commit%/lib/language"
...
SRC_URI="https://github.com/zed-industries/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
LICENSE="0BSD AGPL-3+ Apache-2.0 Apache-2.0-with-LLVM-exceptions BSD BSD-2 Boost-1.0 CC0-1.0 GPL-3+ ISC LGPL-3 MIT MPL-2.0 OFL-1.1 Unicode-DFS-2016 Unlicense ZLIB"
SLOT="0"
KEYWORDS="~amd64"
IUSE+=" +fonts"
