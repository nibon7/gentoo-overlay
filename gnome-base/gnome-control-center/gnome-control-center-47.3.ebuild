...
PATCHES=(
	...
	"${FILESDIR}"/0001-build-Restore-options-for-bluetooth-NetworkMana.patch
	"${FILESDIR}"/0002-build-Make-kerberos-optional.patch.patch
	"${FILESDIR}"/0003-build-Make-gnome-online-accounts-optional.patch
	"${FILESDIR}"/0004-build-Make-printers-panel-cups-optional.patch.patch
	"${FILESDIR}"/0005-Fix-absolute-paths-to-be-dependent-on-build-con.patch
)
