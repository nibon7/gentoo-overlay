...
CRATES="
	...
	gtk4-sys@0.9.5
	gtk4@0.9.5
	gufo-common@0.2.0-alpha.1
	gufo-exif@0.2.0-alpha.1
	gufo-jpeg@0.2.0-alpha.1
	gufo-png@0.2.0-alpha.1
	gufo-tiff@0.2.0-alpha.1
	gufo-webp@0.2.0-alpha.1
	gufo-xmp@0.2.0-alpha.1
	gufo@0.2.0-alpha.1
	gvdb-macros@0.1.14
	gvdb@0.8.0
	gweather-sys@4.5.0
...
src_prepare() {
	...
	sed '/CARGO_HOME/d' -i src/meson.build || die
}
