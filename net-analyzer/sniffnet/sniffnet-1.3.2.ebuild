...
inherit cargo desktop fcaps xdg

DESCRIPTION="Application to comfortably monitor your network traffic"
HOMEPAGE="https://sniffnet.net"
SRC_URI="
	https://github.com/GyulyVGC/sniffnet/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
src_install() {
	...
	domenu resources/packaging/linux/${PN}.desktop

	newicon resources/logos/raw/icon.svg ${PN}.svg

	for size in 16 22 24 32 36 48 64 72 96 128 192 256 512 1024; do
		doicon -s ${size} resources/packaging/linux/graphics/${PN}_${size}x${size}.png
	done
